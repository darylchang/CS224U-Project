...
model = DegreeCentralityModel(lengthPenaltyFn=lambda x: x**3/140. if x<4 else x/3., windowSize=6, lemmatize=False)
model.evaluate(numExamples=50, compute_mistakes=False, verbose=False)
